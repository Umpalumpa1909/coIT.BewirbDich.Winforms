namespace coIT.BewirbDich.Persistence.Constants;
...
internal static class TableNames
{
    ...
    internal const string VersicherungsVorgang = nameof(VersicherungsVorgang);
    ...
    internal const string Versicherungsschein = nameof(Versicherungsschein);
}